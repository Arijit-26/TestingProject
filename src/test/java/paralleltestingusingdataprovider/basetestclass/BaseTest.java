package paralleltestingusingdataprovider.basetestclass;
...
public class BaseTest {
	...
	public void initializeDriver() throws IOException {
		...
		FileInputStream file = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\paralleltestingusingdataprovider\\globalproperty\\GlobalData.properties"); 
		prop.load(file);                        
		...
		this.driver.get().manage().window().maximize(); //This can be written outside the if else block, as this is common for all kinds of browsers
		                       //The driver should be returned . If we declare a web driver in the main test class, and call this method
	}
	...
	public String getScreenShot(String testName,ThreadLocal<WebDriver> driver) throws IOException {
		TakesScreenshot ss= (TakesScreenshot) driver.get();                 //casting our driver with 'TakesScreenshot' class
	...
	public void launchBrowser() throws IOException {                
	 ...
	 @DataProvider(parallel = true)
	    public Object[][] dataProvidingForParallel() throws IOException {
	    	...
	    	FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"\\NUsers.xlsx");
