package paralleltestingusingdataprovider.reusablecodes;
...
public class ReusableComponents {
		...
		public ReusableComponents(ThreadLocal<WebDriver> driver)
		{
			this.driver = driver;
		}
		...
		{
			WebDriverWait w = new WebDriverWait(driver.get(),Duration.ofSeconds(5));
